    ...
    <div className="pt-24 pb-12 px-6 max-w-7xl mx-auto space-y-16">
      {isDemo && (
        <div className="bg-amber-500/10 border border-amber-500/20 rounded-2xl p-4 flex items-center gap-4 text-amber-400">
          <AlertCircle size={20} />
          <p className="text-sm">
            <strong>Демо режимі:</strong> Фильм деректері қазір симуляцияланған.
          </p>
        </div>
      )}

      <section className="relative h-[50vh] sm:h-[60vh] rounded-3xl overflow-hidden flex items-center p-6 sm:p-16">
        ...
        <div className="relative z-10 max-w-2xl space-y-6">
          <motion.h1 
            ...
            className="text-2xl sm:text-7xl font-display font-bold leading-[0.9] tracking-tighter uppercase"
          >
